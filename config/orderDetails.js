...
module.exports = (order) => {
    ...
    *,::after,::before{text-shadow:none!important;box-shadow:none!important;}
    ...
    <body>
        <!-- <h1 style="font-size: 2.6rem; font-weight: bold;" class="display-4 text-center">YOU HAVE A NEW ORDER</h1> -->
        <div class="background">
            ...
            <div class="row">
                <div class="col-1"></div>
                <div class="col-10">
                    <h2 style="font-size: 2rem; font-weight: 400;color:black;" class=" ">ORDER DETAILS</h2>
        ...
        shadow-sm  mb-2">
                    ...
                    <div class="row py-2 text-muted border-bottom">
                                ...
                                <div class="col-md-7">${new Date(order.date).toDateString()}</div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <h2 style="font-size: 2rem; font-weight: 400;color:black;" class=" ">PRODUCTS</h2>
                    ${order.products.map(p => `<div class="d-flex list-group-item py-3 
                    justify-content-between  
                    shadow-sm  mb-2">
                                        <div class="col-md-8 row-wrap mb-3">
                                            ...
                                            <div class="row py-2 text-muted border-bottom">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="mr-2 custom-rounded shadow-sm"
                                                        style="background-color: ${p.color}; width: 10px;"></div>
                                                </div>
                                            </div>
                                            ...
                                            ${p.size == "Custom" ? `
                                            <h2 style="font-size: 1.7rem; font-weight: 400;color:black;margin-top:10px;" class=" ">CUSTOM SIZE DETAILS</h2>
                                        ...
                                        <div class="row py-2 text-muted border-bottom">
                                            <div class="col-md-5">Arm Hole</div>
